  ...
  <div>
        ...
        <el-row>
          <el-col :span="3">
            ...
            <el-form-item label="业务类型">
              <el-select v-model="page.query.param.bizType" :clearable="true" style="width:100px">
                <el-option v-for="item in $dict.store.PAY_BIZ_TYPE" :key="item[0]" :value="item[0]"
          ...
          <el-col :span="8">
            <el-form-item label="支付时间">
              <el-date-picker v-model="orderDateRange" type="datetimerange" range-separator="至" start-placeholder="开始日期"
        ...
        <el-row>
          ...
          <el-col :span="6">
            <el-form-item label=" " >
              ...
              <el-button @click="page.query.param = {};orderDateRange=[] ;search();">取消</el-button>
    ...
    <v-table ref="table" :page="page" class="panel-main" :table-minheight="450">
      ...
      <el-table-column prop="type" label="退付款" width="60">
        <template slot-scope="{row}">
        {{row.bizType==null?"付款":row.bizType==1?'付款':'退款'}}
        </template>
      </el-table-column>
      ...
      <el-table-column prop="payTime" label="支付状态">
        <template slot-scope="{row}">
