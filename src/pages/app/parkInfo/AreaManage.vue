...
<template>
  <div>
    <el-alert title="" type="warning" :closable="false">
      <el-button type="primary" plain class="action" @click="create">添加楼层</el-button>
    </el-alert>
    <v-table ref="table" :page-size="-1" :table-data="tableData" :table-minheight="200" class="panel-main"
             @row-dblclick="onSelectFloor" :auto-select="true">
    ...
    <el-alert title="" type="success" :closable="false">
      <el-button type="primary" plain @click="createArea" class="action" :disabled="currentFloor==null">添加区域</el-button>
      <span v-if="currentFloor">
         楼层: 【{{ currentFloor.code}}】 {{currentFloor.name}}
      </span>
    </el-alert>
