<template>
  <div>
    <el-alert title="" type="info" :closable="false">
      <el-button type="primary" @click="addItem" class="action">添加</el-button>
    </el-alert>
      ...
      <el-table-column prop="remark" label="备注" >
       ...
       <el-table-column label="操作" width="80" >
         <template slot-scope="scope">
          ...
          <el-button type="text" class="action" title="保存" @click="save(scope.row)" v-if="scope.row.editable">
            <i class="el-icon-circle-check"></i>
          </el-button>
          <el-button type="text" class="action" title="编辑" @click="edit(scope.row)" v-else>
            <i class="el-icon-edit"></i>
          </el-button>
          <el-button type="text" class="action" @click="del(scope.row,scope.$index)" title="删除">
