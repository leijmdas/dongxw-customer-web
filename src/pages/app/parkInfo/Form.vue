    ...
    <el-form :model="entity" :rules="rules" ref="form" label-width="100px">
      <el-row>
        <el-col :span="16">
          ...
          <el-form-item v-show="false" label="商户" prop="merchantId">
            <merchant-select v-model="entity.merchantId" :disabled="isDisabled" style="background:white;width:100%"></merchant-select>
          </el-form-item>
          <el-row>
            <el-col :span="8">
          ...
          <el-form-item label="所在区域" prop="areaCode" >
            <area-cascader disabled="true" v-model="entity.areaCode" style="width:100%"></area-cascader>
          </el-form-item>
          ...
          <el-form-item label="地理位置" required>
            ...
            <el-col :span="3" style="padding:0 5px">
              <el-button v-show="false" type="text" class="el-icon-location" title="选择位置" @click="selectLocation"></el-button>
            </el-col>
          </el-form-item>
          <el-form-item label="道闸类型" prop="gateType">
            <el-select v-model="entity.gateType">
              <el-option v-for="item in $dict.store.GATE_TYPE" :key="item[0]" :value="item[0]" :label="item[1]"></el-option>
            </el-select>
          </el-form-item>
        ...
        <el-col :span="8">
          <div style="margin:10px">
            <v-image-uploader :disabled="true" :form-data="{}" v-model="entity.logo" :multiple="bool">
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="计费方式" prop="billWay">
            ...
            <el-select v-model="entity.billWay">
              <el-option v-for="item in $dict.store.BILL_WAY" :key="item[0]" :value="item[0]" :label="item[1]"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        ...
        <el-form-item label="状态" prop="status">
          <el-select v-model="entity.status">
            <el-option v-for="item in $dict.store.PUBLIISH_STATUS" :key="item[0]" :value="item[0]" :label="item[1]"></el-option>
          </el-select>
        </el-form-item>
        </el-col>
        <el-col :span="8">
          ...
          <el-select v-model="entity.isNavigation">
            <el-option v-for="item in [[false,'未开通'],[true,'已开通']]" :key="item[0]" :value="item[0]" :label="item[1]"></el-option>
          </el-select>
        </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="8">
          <el-form-item label="车位总数" prop="totalNum">
            <el-input-number v-model="entity.totalNum" :controls="false"></el-input-number>
          </el-form-item>
        </el-col>
        <el-col :span="8">
...
const defaultEntity = {
  ...
  status: 1,
  remark:
    "此停车场附近有_____，_____，_____，预约停车可享受导航，反向寻车等服务。",
  billRemark: ""
};
export default {
  components: { AreaCascader, AMapLocation, CorpSelect, MerchantSelect },
  data() {
    return {
      bool: true,
      isDisabled: false,
